...
<body class="flex flex-col items-center justify-center relative">
    <div class="loader-container overflow-hidden">
        <div class="img-container flex flex-col items-center justify-center relative">
            <div>
                <img src="{{ Vite::asset('resources/img/illustration.png') }}"
                     alt="illustration Ladyboy Studio" class="max-w-full max-h-[90vh] mx-auto"/>
                <div class="bounding-box z-10 w-38 h-16 top-[55%] left-[54%] rounded-full absolute"></div>
                <div class="eye-outer flex gap-[34%] flex-starts justify-center items-center top-[55%] left-[54%] w-32 h-16 absolute">
                    <div class="left-eye w-8 h-8 rounded-full bg-black"></div>
                    <div class="right-eye mt-36 w-8 h-8 rounded-full bg-black"></div>
                </div>
            </div>
            <div class="img-container-mobile">
                <img src="{{ Vite::asset('resources/img/illustration-mobile.gif') }}" alt=""/>
            </div>
            <div class="fleche">
                <img src="{{ Vite::asset('resources/img/fleche.png') }}" class="w-32 h-32" alt="">
            </div>
        </div>
    </div>

    <div class="shape-wrap">
        <svg class="shape w-full h-full" preserveAspectRatio="none" viewBox="0 0 1440 800">
            <path
